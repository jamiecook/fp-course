...
lift3 ::
  ...
  -> f c
  -> f d
lift3 abcd fa fb fc = fab_cd fa fb <*> fc
  where fab_cd = lift2 abcd
...
lift4 ::
  ...
  -> f d
  -> f e
lift4 f a b c d = f' a b c <*> d -- f <$> a <*> b <*> c <*> d
  where f' = lift3 f
